namespace AzureServiceBusTopicsReceive
{
    using System;
    ...
    public class Program
    {
        ...
        private const string SubscriptionName = "firstsubscription";
        ...
        private static async Task MainAsync()
        {
            ...
            // Register subscrition message handler and receive messages in a loop
        ...
        private static async Task ProcessMessagesAsync(Message message, CancellationToken token)
        {
            ...
            // If subscriptionClient has already been closed, you can choose to not call CompleteAsync() or AbandonAsync(0 etc. to avoid unecessary exceptions
        }
